  ...
  return (
    <header className=" shadow-lg">
      ...
      <div className="headercenter p-4 bg-white flex items-center space-x-20 container ">
        ...
        <div className="flex">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-11 w-11 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="">
          <button
            className="relative flex w-11 h-11 rounded text-blue-600 p-1 "
            onClick={onCartClick}
          >
            <ShoppingBagIcon></ShoppingBagIcon>
            {cartQuantity ? (<div className="absolute pl-[5px] bg-black flex rounded-full top-[25px] right-[25px]  w-5 h-5 text-white">{cartQuantity}</div>) : ''}
          </button>
        </div>
      </div>
      <div className="h-[41px] bg-white">
